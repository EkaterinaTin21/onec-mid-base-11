...
КонецПроцедуры
// ++ Талаева Е.А.18.10.2025
// добавим поле Контактное Лицо на форму документа ЗаказПокупателя
// 
// ++ Талаева Е.А. 19.10.2025
// Добавим поле Согласованная скидка и команду Пересчитать
// Параметры:
// Форма -  ФормаКлиентскогоПриложения - Заказ покупателя
//
Процедура Д_ФормаЗаказа(Форма) Экспорт
		...
		// добавим поле Скидка
		ЭлементСогласованнаяСкидка = Форма.Элементы.Вставить("Д_СогласованнаяСкидка",Тип("ПолеФормы"),Форма.Элементы.ГруппаСкидка);
		...
		ЭлементКомандыПересчитать = Форма.Элементы.Вставить("Пересчитать", Тип("КнопкаФормы"),Форма.Элементы.ГруппаСкидка);
		ЭлементКомандыПересчитать.ИмяКоманды = "Пересчитать";  
		//--
