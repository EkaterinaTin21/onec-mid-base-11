...
// Параметры:
// НастройкиОбъекта - Структура - настройки принятые по умолчаниию
// 
Процедура ПриОпределенииНастроекПечати(НастройкиОбъекта) Экспорт	
	НастройкиОбъекта.ПриДобавленииКомандПечати = Истина;
КонецПроцедуры
//
// Определяем Команды печати 
// Параметры:
// КомандыПечати - Структура - перечисляем печатные формы
// 
...
// Определяем Команды печати 
// Параметры:
// МассивОбъектов - Массив из ОбъектМетаданных - перечисляем документы
// ОбъектыПечати - Массив из ОбъектМетаданных 
// ПараметрыПечати - Структура -настройки печати
// КоллекцияПечатныхФорм - Массив из ОбъектМетаданных- перечень печатных форм
